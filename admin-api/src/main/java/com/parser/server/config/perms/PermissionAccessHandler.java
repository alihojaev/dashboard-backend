...
import com.parser.core.config.permission.annotation.HasPermissions;
...
public class PermissionAccessHandler implements AsyncHandlerInterceptor {
    ...
    private void putMethodGrantHolder(Map<PermissionType, ImmutableAccessPermission> methodGrantHolder) {
        BackendTokenContextHolder.currentOptional()
