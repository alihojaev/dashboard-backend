...
public final class ClientTokenAuthFilter extends BasicAuthenticationFilter {
    private static final String BEARER = "bearer ";

    Gson gson;

    public ClientTokenAuthFilter(AuthenticationManager authenticationManager, Gson gson) {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        try {
            ...
            SecurityContextHolder.getContext().setAuthentication(getAuthenticationManager().authenticate(new ClientTokenContextHolder(token)));
